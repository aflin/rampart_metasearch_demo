...
var message = `There are two versions which produce the same results:
1) Using "rex" in the rampart-sql module to extract with regular expressions:
   http://localhost:8088/apps/metasearch_demo/metasearch_rex.html
2) Using the rampart-html modules to parse and select the relevant sections:
   http://localhost:8088/apps/metasearch_demo/metasearch_html.html
`;
