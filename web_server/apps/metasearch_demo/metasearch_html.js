...
var htmltop="<!DOCTYPE HTML>\n"+
        ...
        '<div id="main" style="padding-bottom:30px;background-color: white; position: absolute; left:200px; top:0px; min-height: 300px; overflow-x: hidden; padding-right: 20px; padding-left: 30px; box-sizing: border-box; width: 600px;">'+
          '<form id="mf" action="/apps/metasearch_demo/metasearch_html.html">'+
            '<div style="width:100%">'+
...
/*
{
   "https://en.wikipedia.org/wiki/Paris": {
      ...
      "duckduckgo": {
         ...
         "desc": "Paris (French pronunciation: [paʁi] (listen)) is the capital and most populous city of France, with an estimated population of 2,165,423 residents in 2019 in an area of more than 105 square kilometres (41 square miles).",
         "pos": 0
      },
      "google": {
         "title": "Paris - Wikipedia",
      ...
      "ask": {
         "title": "Paris - Wikipedia",
         "desc": "Paris is located in northern central France, in a north-bending arc of the river Seine whose crest includes two islands, the Île Saint-Louis and the larger Île ...",
         "pos": 3
      }
   },
*/
function comboformat(obj,q)
{
    ...
    for (var i=0;i<keys.length;i++)
    {
        ...
        var keys2=Object.keys(urlobj);
        for (var j=0;j<keys2.length;j++)
        {
            // key2 is either the engine name (i.e., "google" or "lowestpos")
            var key2=keys2[j];
            engent=urlobj[key2];
            if(key2=='lowestpos'){
                newent.pos=engent;
            ...
            if(engent.title && newent.title.length<engent.title.length)
                newent.title=engent.title;

            if(engent.desc && newent.desc.length<engent.desc.length)
...
function gparse(txt,obj)
{
    ...
    /* a record:
        <div class="ZINbbc luh4tb xpd O9g5cc uUPGi">
          <div class="egMi0 kCrYT">
            <a href="/url?q=https://en.wikipedia.org/wiki/Paris&amp;sa=U&amp;ved=2ahUKEwi84s3ZwqP2AhWnEEQIHcahAocQFnoECB0QAg&amp;usg=AOvVaw0CVTlVCFRcbprhNjdzSkzR">
                ...
                <div>
                  <div class="MSiauf">
                    <div class="BNeawe s3v9rd AP7Wnd">
                      ...
                      of France, with an estimated population of
                      2,165,423 residents in 2019 in an area of
                      more than 105 square&nbsp;...
                    </div>
                  </div>
                  <div class="MSiauf">
                    <div class="BNeawe s3v9rd AP7Wnd">
                      <span class="BNeawe"><a href=
                      "/url?q=https://en.wikipedia.org/wiki/History_of_Paris&amp;sa=U&amp;ved=2ahUKEwi84s3ZwqP2AhWnEEQIHcahAocQ0gJ6BAgdEAU&amp;usg=AOvVaw3iFNI3CZZERNS9qGn6Q55v">
                      <span class=
                      "XLloXe AP7Wnd">History</span></a></span> ·
                      <span class="BNeawe"><a href=
                      "/url?q=https://en.wikipedia.org/wiki/Geography_of_Paris&amp;sa=U&amp;ved=2ahUKEwi84s3ZwqP2AhWnEEQIHcahAocQ0gJ6BAgdEAY&amp;usg=AOvVaw1wtXJCNJ8jpi7eOBW09dEO">
                      <span class="XLloXe AP7Wnd">Geography of
                      Paris</span></a></span> · <span class=
                      "BNeawe"><a href=
                      "/url?q=https://en.wikipedia.org/wiki/Paris_(disambiguation)&amp;sa=U&amp;ved=2ahUKEwi84s3ZwqP2AhWnEEQIHcahAocQ0gJ6BAgdEAc&amp;usg=AOvVaw2fZYa8bFag1IlXrIuym8el">
                      <span class="XLloXe AP7Wnd">Paris
                      (disambiguation)</span></a></span> ·
                      <span class="BNeawe"><a href=
                      "/url?q=https://en.wikipedia.org/wiki/Timeline_of_Paris&amp;sa=U&amp;ved=2ahUKEwi84s3ZwqP2AhWnEEQIHcahAocQ0gJ6BAgdEAg&amp;usg=AOvVaw3QiqIUxcUPC2tEVhMYfVQE">
                      <span class="XLloXe AP7Wnd">Timeline of
                      Paris</span></a></span>
                    </div>
                  </div>
                  <div>
                    <div class="BNeawe s3v9rd AP7Wnd">
                      Population (Jan. 2019): <span class=
                      "xUrNXd UMOHqf">2,165,423</span><br>
                      Area1: <span class="xUrNXd UMOHqf">105.4 km2
                      (40.7 sq mi)</span><br>
                      Country: <span class="BNeawe"><a href=
                      "/url?q=http://en.wikipedia.org/wiki/France&amp;sa=U&amp;ved=2ahUKEwi84s3ZwqP2AhWnEEQIHcahAocQs2Z6BAgdEAw&amp;usg=AOvVaw29N7qcwV4SVU_Rz0yfUb77">
                      <span class=
                      "XLloXe AP7Wnd">France</span></a></span><br>
                      Region: <span class="BNeawe"><a href=
                      "/url?q=http://en.wikipedia.org/wiki/%25C3%258Ele-de-France&amp;sa=U&amp;ved=2ahUKEwi84s3ZwqP2AhWnEEQIHcahAocQs2Z6BAgdEA4&amp;usg=AOvVaw2gUN4t9buaZC2-xnvbdEtw">
                      <span class=
                      "XLloXe AP7Wnd">Île-de-France</span></a></span>
                    </div>
                  </div>
                </div>
              </div>
    ...
    */
    ...
    var descs=a.parent().next().children().children().children().children().toText();

    var j=0;
    for (var i=0; i<hrefs.length; i++) {
        var url = hrefs[i].match(/http[^&]+/);

        if(url && url.length) url = url=sprintf("%!U", url[0]);
        else continue;
